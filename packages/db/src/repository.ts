...
export class RealAddrRepository {
  ...
  async consumeRateLimit(subjectHash: string, action: 'wallet_challenge' | 'agent_api' | 'human_api' | 'human_bootstrap' | 'ens_resolve', limit: number, windowMs: number): Promise<void> {
