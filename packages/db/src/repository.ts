...
export class RealAddrRepository {
  ...
  async consumeRateLimit(subjectHash: string, action: 'wallet_challenge' | 'agent_api' | 'human_api' | 'human_bootstrap' | 'ens_resolve' | 'admin_login' | 'admin_api', limit: number, windowMs: number): Promise<void> {
